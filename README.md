...
1. Git clone ````https://github.com/miciron/laba1_2````
...
* При запуске приложения в Logcat выведутся строки показанные на картинке ниже.

![image](https://github.com/miciron/laba3/assets/36693998/576dd06c-2431-4e79-aa2c-04fc9a1bbd56)
